...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#F7F9F8] text-[#6B7280] min-h-screen selection:bg-emerald-100 selection:text-emerald-900 font-sans antialiased">
      ...
      <header className="border-b border-slate-200/50 bg-[#F7F9F8]/95 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a 
              href="#cta" 
              className="inline-flex items-center justify-center px-4 py-2.5 text-xs font-bold rounded bg-[#2D8C74] hover:bg-[#12372A] text-white transition-colors"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white border border-slate-200 rounded-xl shadow-premium overflow-hidden font-sans flex h-[500px] w-full">
              ...
              {/* Sidebar Panel */}
              <div className="w-44 bg-[#111827] text-slate-300 p-5 border-r border-slate-800 flex flex-col justify-between flex-shrink-0 text-xs font-semibold">
                <div className="space-y-8">
                  ...
                  <div className="space-y-2">
                    <button 
                      ...
                      className={`w-full flex items-center space-x-3 px-3 py-2 rounded transition-colors text-left ${activeTab === "overview" ? "bg-slate-800 text-white" : "hover:bg-slate-800/50 hover:text-white"}`}
                    >
                    ...
                    <button 
                      ...
                      className={`w-full flex items-center space-x-3 px-3 py-2 rounded transition-colors text-left ${activeTab === "policies" ? "bg-slate-800 text-white" : "hover:bg-slate-800/50 hover:text-white"}`}
                    >
                ...
                <div className="border-t border-slate-800 pt-4 flex items-center space-x-3 truncate">
                  <div className="h-6 w-6 rounded-full bg-[#2D8C74] flex items-center justify-center text-[10px] font-bold text-white">AD</div>
                  <div className="truncate">
                    <p className="text-xs text-white leading-none">admin@flientsec.local</p>
                  </div>
                </div>
              </div>

              {/* Main Panel Header & View Split */}
              <div className="flex-1 bg-[#F7F9F8] flex flex-col overflow-hidden text-xs text-[#6B7280]">
                
                {/* Internal Mock Header */}
                <div className="h-12 border-b border-slate-200 bg-white px-5 flex items-center justify-between flex-shrink-0">
                  <span className="font-bold text-[#111827] text-xs">
                    {activeTab === "overview" ? "Workstation Fleet Security" : "YAML Security baseline rules"}
                  </span>
                  <span className="text-[10px] border border-slate-200 px-2 py-0.5 rounded bg-[#F7F9F8] font-bold text-[#6B7280]">
                    Default Org
                  </span>
                </div>
                ...
                <div className="flex-1 overflow-hidden">
                  {activeTab === "overview" ? (
                    ...
                    <div className="flex h-full divide-x divide-slate-200">
                      ...
                      <div className="w-1/2 bg-white overflow-y-auto divide-y divide-slate-100">
                        ...
                        <button 
                          ...
                          className={`w-full p-3.5 text-left flex flex-col space-y-1.5 transition-colors ${selectedDevice === "macbook" ? "bg-[#F7F9F8]" : "hover:bg-slate-50"}`}
                        >
                          <div className="flex items-center justify-between">
                            <span className="font-bold text-[#111827] text-xs truncate">macbook-pro-01</span>
                            <span className="h-2 w-2 rounded-full bg-emerald-500"></span>
                          </div>
                          <div className="flex justify-between items-center text-[10px]">
                            <span className="text-emerald-600 bg-emerald-50 px-1.5 rounded font-bold">PASS (100)</span>
                        ...
                        <button 
                          ...
                          className={`w-full p-3.5 text-left flex flex-col space-y-1.5 transition-colors ${selectedDevice === "ubuntu" ? "bg-[#F7F9F8]" : "hover:bg-slate-50"}`}
                        >
                          <div className="flex items-center justify-between">
                            <span className="font-bold text-[#111827] text-xs truncate">ubuntu-laptop-02</span>
                            <span className="h-2 w-2 rounded-full bg-emerald-500"></span>
                          </div>
                          <div className="flex justify-between items-center text-[10px]">
                        ...
                        <button 
                          ...
                          className={`w-full p-3.5 text-left flex flex-col space-y-1.5 transition-colors ${selectedDevice === "arch" ? "bg-[#F7F9F8]" : "hover:bg-slate-50"}`}
                        >
                          <div className="flex items-center justify-between">
                            <span className="font-bold text-[#111827] text-xs truncate">arch-workstation-03</span>
                            <span className="h-2 w-2 rounded-full bg-slate-350"></span>
                          </div>
                          <div className="flex justify-between items-center text-[10px]">
                            <span className="text-emerald-600 bg-emerald-50 px-1.5 rounded font-bold">PASS (90)</span>
                      ...
                      <div className="w-1/2 p-4 overflow-y-auto space-y-4 bg-[#F7F9F8]">
                        {selectedDevice === "macbook" && (
                          <div className="space-y-3">
                            <h4 className="font-bold text-[#111827] text-xs">macbook-pro-01</h4>
                            <p className="text-[10px] text-[#6B7280]">macOS 14.2.1 • M2 Max</p>
                            <div className="border border-slate-200/50 rounded-lg bg-white p-3 space-y-2 font-mono text-[10px]">
                        ...
                        {selectedDevice === "ubuntu" && (
                          <div className="space-y-4">
                            <div>
                              ...
                              <p className="text-[10px] text-[#6B7280] mt-0.5">Ubuntu 22.04 LTS • Kernel 5.15</p>
                            </div>

                            {/* Compliance checks checklist with interactive switch */}
                            <div className="space-y-2">
                              {/* Firewall check row */}
                              <div className="border border-slate-200/50 rounded-lg bg-white p-3 flex items-center justify-between font-mono text-[10px]">
                                ...
                                <button 
                                  ...
                                  className={`w-8 h-4.5 rounded-full p-0.5 transition-colors focus:outline-none ${firewallActive ? "bg-[#2D8C74]" : "bg-slate-350"}`}
                                >
                                  <div className={`bg-white w-3.5 h-3.5 rounded-full shadow-sm transform transition-transform ${firewallActive ? "translate-x-3.5" : "translate-x-0"}`}></div>
                                </button>
                              </div>
                            ...
                            <div className="bg-slate-900 text-slate-350 rounded p-3 font-mono text-[9px] space-y-1.5 border border-slate-800">
                              <p className="text-slate-500 uppercase tracking-widest font-bold text-[8px]">Heartbeat Events</p>
                        ...
                        {selectedDevice === "arch" && (
                          <div className="space-y-2">
                            ...
                            <p className="text-[10px] text-[#6B7280]">Arch Linux • Kernel 6.9.1</p>
                            <div className="border border-slate-200/50 rounded-lg bg-white p-3 space-y-2 font-mono text-[10px]">
                              <div className="flex items-center justify-between text-emerald-600 font-bold">
                    ...
                    <div className="p-5 h-full bg-slate-950 font-mono text-[10px] text-slate-300 overflow-y-auto leading-relaxed select-all">
      ...
      {/* 4. Trust Badges Strip (Bordered Pill Chips) */}
      <section className="py-10 border-y border-slate-200/50 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-[10px] font-bold text-[#6B7280] uppercase tracking-widest mb-6">
            Designed for Linux Engineering Teams • Open Architecture • Privacy by Design
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-xs font-semibold text-[#111827]">
            <span className="border border-slate-200 px-3 py-1.5 rounded-full bg-[#F7F9F8]">Linux Native</span>
            <span className="border border-slate-200 px-3 py-1.5 rounded-full bg-[#F7F9F8]">Policy as Code</span>
            <span className="border border-slate-200 px-3 py-1.5 rounded-full bg-[#F7F9F8]">Privacy First</span>
            <span className="border border-slate-200 px-3 py-1.5 rounded-full bg-[#F7F9F8]">Real-Time Verification</span>
          </div>
        </div>
      </section>
      ...
      {/* 6. Who is FlientSec NOT for? Box */}
      ...
      {/* 7. Platform Features (Left-Aligned, Asymmetric visual rhythm formats) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-4">
              ...
              <div className="border border-slate-200 bg-white rounded-lg overflow-hidden font-mono text-[10px] leading-none shadow-sm">
                ...
                <div className="p-3 flex justify-between border-t border-slate-100">
      ...
      <section id="architecture" className="py-24 bg-white border-t border-slate-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          <div className="space-y-4">
            ...
            <p className="text-base sm:text-lg text-[#6B7280] font-normal leading-relaxed max-w-2xl">
            ...
            <div className="bg-[#F7F9F8] border border-slate-200 rounded-xl p-8 flex flex-col justify-center space-y-5">
              ...
              <div className="space-y-3.5 text-xs font-mono">
                <div className="flex items-center justify-between border-b border-slate-200 pb-2.5">
                  ...
                  <span className="text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded font-bold">PASS</span>
                </div>
                <div className="flex items-center justify-between border-b border-slate-200 pb-2.5">
      ...
      {/* 10. Comparison Table (Light Background, Differentiator row) */}
      <section className="py-24 bg-white border-t border-slate-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          <div className="space-y-4">
          ...
          <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm bg-white max-w-4xl mx-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50 text-[#111827] text-xs font-bold uppercase tracking-wider">
              ...
              <tbody className="divide-y divide-slate-100 text-sm text-[#6B7280] font-medium">
                <tr className="hover:bg-slate-50/50 transition-colors">
                  <td className="px-6 py-4 font-semibold text-[#111827]">Linux Native Support</td>
                  <td className="px-6 py-4 text-center"><X className="h-4.5 w-4.5 text-rose-400 mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><X className="h-4.5 w-4.5 text-rose-400 mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-emerald-50/20"><Check className="h-4.5 w-4.5 text-[#2D8C74] mx-auto" /></td>
                </tr>
                <tr className="hover:bg-slate-50/50 transition-colors">
                  <td className="px-6 py-4 font-semibold text-[#111827]">Continuous security baseline verification</td>
                  <td className="px-6 py-4 text-center"><X className="h-4.5 w-4.5 text-rose-400 mx-auto" /></td>
                  <td className="px-6 py-4 text-center"><Check className="h-4.5 w-4.5 text-[#2D8C74] mx-auto" /></td>
                  <td className="px-6 py-4 text-center bg-emerald-50/20"><Check className="h-4.5 w-4.5 text-[#2D8C74] mx-auto" /></td>
                </tr>
                <tr className="hover:bg-slate-50/50 transition-colors">
      ...
      <section className="py-24 bg-white border-t border-slate-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="max-w-xl mx-auto bg-[#F7F9F8] border border-slate-200 rounded-xl p-8 shadow-sm">
            <h3 className="text-sm font-bold text-[#111827] border-b border-slate-200 pb-4 flex items-center space-x-2">
              <Lock className="h-4.5 w-4.5 text-[#2D8C74]" />
              <span>Developer Telemetry Boundaries</span>
            </h3>
            <ul className="space-y-5 text-sm font-semibold text-slate-700 mt-6">
              <li className="flex items-center space-x-3">
                <span className="h-6 w-6 rounded-full bg-emerald-50 text-[#2D8C74] flex items-center justify-center"><Check className="h-4 w-4" /></span>
      ...
      {/* 12. Plans Section (Deployment options) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-5xl mx-auto">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-8 flex flex-col justify-between space-y-8 shadow-sm">
              <div className="space-y-4">
                <h4 className="font-bold text-[#111827] text-base">Community</h4>
                <p className="text-xs text-[#6B7280]">For individual developers and open architecture teams.</p>
                <div className="pt-2">
                  <span className="text-3xl font-black text-[#111827]">Free</span>
                </div>
                <ul className="space-y-3 text-xs font-semibold text-slate-700 pt-5 border-t border-slate-100">
                  <li className="flex items-center space-x-2">
                    <Check className="h-3.5 w-3.5 text-[#2D8C74]" />
              ...
              <a 
                href="/dashboard"
                className="w-full inline-flex items-center justify-center px-5 py-3 border border-slate-200 hover:bg-slate-50 text-[#6B7280] text-xs font-bold rounded-lg transition-colors text-center"
              >
                Access Client Code
              </a>
            </div>
            ...
            <div className="bg-white border border-[#2D8C74] rounded-xl p-8 flex flex-col justify-between space-y-8 shadow-sm relative">
              ...
              <div className="space-y-4">
                <h4 className="font-bold text-[#111827] text-base">Design Partner</h4>
                <p className="text-xs text-[#6B7280]">For engineering teams building security maturity.</p>
                <div className="pt-2">
                  <span className="text-3xl font-black text-[#111827]">Request Access</span>
                </div>
                <ul className="space-y-3 text-xs font-semibold text-slate-700 pt-5 border-t border-slate-100">
                  <li className="flex items-center space-x-2">
                    <Check className="h-3.5 w-3.5 text-[#2D8C74]" />
              ...
              <a 
                href="#cta"
                className="w-full inline-flex items-center justify-center px-5 py-3 bg-[#2D8C74] hover:bg-[#12372A] text-white text-xs font-bold rounded-lg transition-colors text-center"
              >
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-8 flex flex-col justify-between space-y-8 shadow-sm">
              <div className="space-y-4">
                <h4 className="font-bold text-[#111827] text-base">Enterprise</h4>
                <p className="text-xs text-[#6B7280]">For audited environments requiring strict history tracking.</p>
                <div className="pt-2">
                  <span className="text-3xl font-black text-[#111827]">Contact Sales</span>
                </div>
                <ul className="space-y-3 text-xs font-semibold text-slate-700 pt-5 border-t border-slate-100">
                  <li className="flex items-center space-x-2">
                    <Check className="h-3.5 w-3.5 text-[#2D8C74]" />
      ...
      {/* 13. FAQ Section (Centered alignment tag, Left accordion lists) */}
      <section className="py-24 bg-white border-t border-slate-200/50">
            ...
            {faqData.map((item, idx) => (
              <div key={idx} className="py-5">
                <button 
                  ...
                  className="w-full flex items-center justify-between text-left font-bold text-[#111827] text-base focus:outline-none"
                >
                  <span>{item.q}</span>
                  <ChevronDown className={`h-4.5 w-4.5 text-slate-400 transform transition-transform ${openFaq === idx ? "rotate-180" : "rotate-0"}`} />
                </button>
                {openFaq === idx && (
                  <p className="mt-3 text-sm text-[#6B7280] leading-relaxed font-semibold transition-all">
                    {item.a}
                  </p>
                )}
              </div>
      ...
      {/* 14. Final CTA (Deep Green Background #12372A, High Contrast White Title) */}
      <section id="cta" className="py-24 bg-white border-t border-slate-200/50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#12372A] rounded-xl p-12 text-center text-white space-y-8 shadow-lg relative overflow-hidden">
            
            <div className="space-y-4 relative z-10">
              <span className="text-[10px] font-bold text-emerald-300 uppercase tracking-widest">
                Enroll Today
              </span>
              <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-white pt-2">
                Start continuously verifying every workstation.
              </h2>
              <p className="text-emerald-100/70 text-sm sm:text-base max-w-lg mx-auto font-semibold leading-relaxed">
            ...
            <div className="flex flex-row items-center justify-center gap-4 relative z-10">
              <button 
                ...
                className="inline-flex items-center justify-center px-6 py-3.5 bg-[#2D8C74] hover:bg-emerald-800 text-white text-xs font-bold rounded-lg transition-colors shadow-sm"
              >
                Request Early Access
              </button>
              <a 
                href="/dashboard"
                className="inline-flex items-center justify-center px-6 py-3.5 border border-emerald-500/30 hover:bg-emerald-850/20 text-emerald-300 text-xs font-semibold rounded-lg transition-colors"
              >
