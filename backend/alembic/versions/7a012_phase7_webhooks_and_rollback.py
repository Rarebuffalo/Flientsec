...
def upgrade() -> None:
    ...
    # 2. Create webhooks table if not exists
    ...
    # 3. Create webhook_deliveries table if not exists
...
def downgrade() -> None:
    ...
    if insp.has_table('webhook_deliveries'):
        try:
